...
final class SettingsViewController: UIViewController {
    ...
    init(qualityPreferenceRepository: QualityPreferenceRepository = AppDIContainer.shared.makeQualityPreferenceRepository()) {
    ...
    private func buildSections() {
        let currentQuality = qualityPreferenceRepository.globalPreferredQuality ?? "Авто"
    ...
    private func showQualityPicker(row: SettingsValueRow) {
        ...
        var items: [PickerViewController.Item] = [
            .init(primary: "Авто", secondary: "Лучшее доступное", isSelected: qualityPreferenceRepository.globalPreferredQuality == nil)
        ]
        items += qualities.map { q in
            .init(primary: q, secondary: nil, isSelected: q == qualityPreferenceRepository.globalPreferredQuality)
        }
